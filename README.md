...
## Data
The data set, I have fed into my convolutional neural network came from kaggle (https://www.kaggle.com/slothkong/10-monkey-species). I just want to take a moment to thank all the people who has contributed to the dataset and making it more accessible.
